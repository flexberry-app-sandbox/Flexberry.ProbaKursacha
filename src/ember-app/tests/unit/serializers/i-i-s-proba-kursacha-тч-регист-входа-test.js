...
moduleForModel('i-i-s-proba-kursacha-тч-регист-входа', 'Unit | Serializer | i-i-s-proba-kursacha-тч-регист-входа', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-proba-kursacha-тч-регист-входа',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
