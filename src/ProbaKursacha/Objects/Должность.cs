...
namespace IIS.ProbaKursacha
{
    ...
    public class Должность : ICSSoft.STORMNET.DataObject
    {
        ...
        /// КодДолжн.
        /// </summary>
        // *** Start programmer edit section *** (Должность.КодДолжн CustomAttributes)

        // *** End programmer edit section *** (Должность.КодДолжн CustomAttributes)
        public virtual int КодДолжн
        {
            get
            {
                // *** Start programmer edit section *** (Должность.КодДолжн Get start)

                // *** End programmer edit section *** (Должность.КодДолжн Get start)
                int result = this.fКодДолжн;
                // *** Start programmer edit section *** (Должность.КодДолжн Get end)

                // *** End programmer edit section *** (Должность.КодДолжн Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Должность.КодДолжн Set start)

                // *** End programmer edit section *** (Должность.КодДолжн Set start)
                this.fКодДолжн = value;
                // *** Start programmer edit section *** (Должность.КодДолжн Set end)

                // *** End programmer edit section *** (Должность.КодДолжн Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДолжностьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДолжностьE", typeof(IIS.ProbaKursacha.Должность));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДолжностьL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДолжностьL", typeof(IIS.ProbaKursacha.Должность));
                }
            }
        }
    }
