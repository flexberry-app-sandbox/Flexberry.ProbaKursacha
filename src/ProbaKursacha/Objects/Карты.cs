    ...
    public class Карты : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КартыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартыE", typeof(IIS.ProbaKursacha.Карты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КартыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КартыL", typeof(IIS.ProbaKursacha.Карты));
                }
            }
        }
    }
